...
The Vite~\cite{Ghosh2018, Ghosh2018a, Ghosh2019} (CPU) and Gunrock~\cite{Wang2016} (GPU) implement The Louvain algorithm in AGHAB, with minor changes.
    ...
    \underline{\textbf{Gunrock Louvain}}
        ...
        % Gunrock`s programming model is a better fit for high-performance GPU implementations than traditional programming models adapted from CPUs. 
        ...
        % To run the implementation the following parameterized information is needed: input graph file name, path to the file, and number of threads. 
