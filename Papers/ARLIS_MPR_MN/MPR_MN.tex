...
\begin{multicols}{2}    
    ...
    \section{Background and Related Work}\label{section:background}
        ...
        Use of synthetic data dominates, with the 2004 Recursive Matrix algorithm \cite{Chakrabarti2004} and its successors like the Kroenecker \cite{Leskovec2010}core among them. 
...
%The current limitation of the Louvian algo is X, which we will measure using Y to determine its impact
    ...
    \section{Telemetry Tools}\label{section:telemetry}
        ...
        \osullikomment{Group together aS utlitlites (eg. perf, oprofile prof) and applications (HPCTOOLKIT, Valgring, VTUNE) footnote the links to their repos etc}
