...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.1.0-489-g4b3d7c2f"
  WORKING_DIRECTORY "/home/nanir/gunrock/externals/rapidjson"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "v1.1.0-489-g4b3d7c2f")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.1.0-489-g4b3d7c2f" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v1.1.0-489-g4b3d7c2f")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nanir/gunrock/externals/rapidjson'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nanir/gunrock/externals/rapidjson'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
